...
public class ProfileChangePassword extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    private static  final String TAG = ProfileChangePassword.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        HashMap<String, String> userdetails = sessionManagement.getSessionDetails();
        mobile = userdetails.get(SessionManagement.MOBILE);
        Log.d(TAG, "usermobilenumber: "+mobile);
    ...
    void loginBackButton(){
        Intent i = new Intent(ProfileChangePassword.this, MainActivity.class);
        startActivity(i);
        finish();
    ...
    void changePassword() {
        ...
        if (TextUtilsInput.getString(editTextreenterPassword).isEmpty()) {
            ...
            textInputreenterPassword.setError("password should  atleast 6 characters");
            return;
        }
        */
                    ...
                    try {
                        if (response.body() != null) {
                            ...
                            if (object.getBoolean("status")) {
                                Intent i = new Intent(ProfileChangePassword.this, LoginActivity.class);
                                startActivity(i);
                                finish();
                            ...
                            TextUtilsInput.backgroundThreadShortToast(ProfileChangePassword.this,object.getString("message"));
    ...
    private void showSnack(boolean isConnected) {
        ...
        if (!isConnected) {
            noConnection(ProfileChangePassword.this);
        }
    }
